...
and silently defeat the detector, e.g.:
  ...
  "Each party shall hold harmless the other party ... In addition, the
  Company shall indemnify Institution for any and all claims ... without
  limit."
  ...
  -> the exempt phrase "hold harmless the other party" matched somewhere
     ...
     in the hunk, including the separate, non-exempt "the Company shall
