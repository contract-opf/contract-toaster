...
each hard-coded playbook JSON path (or a lexically-last glob over
...
"playbooks/samples/synthetic-nda-sample-v1.0.0.json"), matching every other path convention in this
