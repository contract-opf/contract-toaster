...
export default function AdminUsers({
  ...
  useEffect(() => {
    ...
    void loadMe();
    void loadAuthMode();
  }, [loadUsers, loadSyncStatus, loadMe, loadAuthMode, credentialsRefreshKey]);
  ...
  return (
    <section data-testid="admin-users-panel" className="ct-section ct-stack">
      ...
      {/* Settings at the bottom: Sign-in method and Recovery in 2 columns */}
      <CtColumns>
        ...
        <div className="ct-stack">
          ...
          <CtBanner variant="muted">
            <details data-testid="break-glass-note">
              <summary>Emergency admin recovery (read-only)</summary>
              <p>
                ...
                restoring admin access&quot; for the procedure. This UI cannot invoke emergency recovery.
              </p>
            </details>
          </CtBanner>
        </div>
