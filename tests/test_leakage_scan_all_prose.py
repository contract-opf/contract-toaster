...
ACCEPT_VERDICT_WITH_LEAK = (
    ...
    "The Company standard liability cap is $150,000 and the counterparty has kept this in place. "
...
PARAPHRASE_VERDICT = (
    ...
    "at one hundred and fifty thousand dollars, which is consistent with the Company's positions. "
    "Acceptable."
)
