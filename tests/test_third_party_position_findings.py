...
## What this test asserts (mirrors the issue's Required verification)
  ...
  5. Every human-facing rationale string is free of tenant-brand strings and uses
     "your" voicing.
...
# #249 matcher, over the synthetic-generic playbook fixture (issue #410).
# ---------------------------------------------------------------------------

# The synthetic-generic fixture is a structural clone of the real eiaa
# playbook (same topic ids, hard_rejections, and vocabulary shape) -- this
# file's fixtures are matched against that vocabulary specifically.
    ...
    for finding in findings:
        ...
        if "exos" in rationale.lower():
            failures.append(
                ...
                f"tenant-brand strings: {rationale!r}"
            )
