...
_VALID_PRECISION = {
    # Any set of real, existing paths does here -- bind_bundle._validate_
    # precision_paths() only checks existence, not content (issue #410:
    # repointed off the real eiaa playbook onto the already-committed,
    # brand-free "sample-agreement" demo playbook's artifacts; issue #412
    # deleted that playbook -- repointed again onto "synthetic-generic",
    # the renamed former "eiaa" registry entry the test suite still
    # resolves fixtures through).
    "anchor_map_path": "standard-forms/synthetic-generic-v1.0.0.anchor-map.json",
    "section_config_path": "tests/fixtures/playbooks/synthetic-generic-v1.0.0.sections.json",
    "standard_form_docx": None,
    "legacy_playbook_path": "tests/fixtures/playbooks/synthetic-generic-v1.0.0.json",
}
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        result = subprocess.run(
            [
                ...
                # OPF-bind path, not policy resolution.
                "--no-policy",
                "--approved-by",
                "test-approver",
                "--approved-at",
