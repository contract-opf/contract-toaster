...
PLAYBOOK_FRAGMENT = "The Company standard liability cap is $150,000 aggregate."
...
class TestPlaybookLeakage(unittest.TestCase):
    ...
    def test_normalized_case_and_whitespace_variant_is_still_blocked(self) -> None:
        ...
        variant = "THE   company   STANDARD liability CAP is $150,000   aggregate."
...
class TestStandardClauseAllowlist(unittest.TestCase):
    """Issue #208: a faithful on_remove_or_alter restoration of the
