...
# synthetic-generic playbook fixture (issue #410).
# ---------------------------------------------------------------------------

# This file's fixtures below (confidentiality/indemnification clause text)
# are matched against the synthetic-generic fixture's topic vocabulary,
# which is a structural clone of the real eiaa playbook (same topic ids,
# section_refs, and our_standard shape) -- see tests/fixtures/playbooks/.
