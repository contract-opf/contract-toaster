...
The playbook's no-exos-indemnity rule used to set
...
def test_invalid_regex_trigger_term_raises_not_silently_falls_back() -> None:
    malformed_rule = {
        ...
        "kind": "on_insert",
        "trigger_terms": [],
        "regex_trigger_terms": [r"company (shall|will indemnif"],  # unbalanced paren
    }
    text = "The Company shall indemnify Institution for any claim."
    try:
...
NO_EXOS_INDEMNITY_FIXTURE_CASE_IDS = {
    ...
    "reject-one-way-will-indemnify",
    "reject-one-way-indemnify",
