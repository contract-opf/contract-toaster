...
D2_CASES = [
    ...
    },
    {
        ...
        "description": (
            ...
            "specifying minimum coverage levels exceeding the Company's standard program."
        ),
        ...
        "hunk": {
            ...
            "kind": "inserted",
            "text": (
                "ARTICLE 13. INSURANCE REQUIREMENTS. The Company shall maintain commercial "
                "general liability insurance with minimum coverage limits of $5,000,000 "
                "per occurrence. The Company shall provide certificates evidencing such "
    ...
    },
    {
        ...
        "description": (
            ...
            "the Company to indemnify the institution. This is the primary scenario the issue "
        ...
        "hunk": {
            ...
            "kind": "inserted",
            "text": (
                "ARTICLE 14. INDEMNIFICATION. The Company shall indemnify, defend, and hold "
                ...
                "out of or resulting from the acts or omissions of the Company or the students "
                "placed by the Company at the Institution's facilities."
            ),
        },
        "expected_fire": True,
    },
