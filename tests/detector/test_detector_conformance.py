...
ON_INSERT_CASES: list[tuple[str, dict, dict, bool, str]] = [
    ...
    (
        "regex_mode_applies_to_whole_trigger_terms_list",
        {
            "id": "regex-rulewide",
            "kind": "on_insert",
            "trigger_terms": [r"company\s+shall\s+indemnif\w*"],
            "match": "regex",
        },
        {"variation_text": "The Company shall indemnify Institution.", "topic_id": "t"},
        True,
    ...
    (
        "regex_trigger_terms_independent_of_match_mode",
        {
            ...
            "match": "word_boundary",
            "regex_trigger_terms": [r"company\s+shall\s+indemnif\w*"],
        },
        {
            "variation_text": "The Company shall indemnify Institution for any and all claims.",
            "topic_id": "t",
        },
        True,
    ...
    (
        ...
        },
        {
            "variation_text": (
                ...
                "Institution shall be the exclusive provider of interns to the Company nationwide."
            ),
            "topic_id": "t",
        },
        True,
