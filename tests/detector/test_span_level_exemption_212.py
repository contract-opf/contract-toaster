...
COMBINED_HUNKS = {
    "no-exos-indemnity": [
        (
            ...
            "In addition, the Company shall indemnify Institution for any "
            "and all claims, damages, and losses, without limit.",
        ),
        (
            "violation_first",
            "The Company shall indemnify Institution for any and all "
            "claims, damages, and losses, without limit. In addition, each "
            "party shall hold harmless the other party from ordinary "
            "third-party claims arising in the normal course of business.",
        ),
    ],
    "no-exclusivity": [
        (
            ...
            "Institution shall be the exclusive provider of interns to the "
            "Company nationwide.",
        ),
        (
            "violation_first",
            "Institution shall be the exclusive provider of interns to the "
            "Company nationwide. This Agreement is non-exclusive as to "
            "placements in Arizona.",
        ),
    ],
}
...
ADVERSARIAL_FIXTURE_CASE_IDS = {
    "reject-combined-hunk-indemnity-exempt-first",
    "reject-combined-hunk-indemnity-violation-first",
