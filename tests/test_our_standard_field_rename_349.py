...
## What this test asserts
  ...
  2. Loading the real `synthetic-generic` playbook via
...
def check_loaded_playbook_uses_our_standard() -> list[str]:
    print("\nCheck 2: loaded 'synthetic-generic' playbook topics carry 'our_standard' text …")
    failures: list[str] = []
    ...
    try:
        ...
        return _assert(False, "load_and_validate_playbook('synthetic-generic') succeeds", repr(exc))
