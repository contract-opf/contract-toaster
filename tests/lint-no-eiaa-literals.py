...
literal `"playbooks/<eiaa's playbook filename>.json"` path) anywhere in the
required core breaks that property silently: the code keeps working for eiaa and nothing
