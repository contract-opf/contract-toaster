...
prose may reference tenant-brand strings (release de-brand voicing). The
...
# Prose fields scanned for tenant-brand strings -- free text a fixture author
...
def main() -> int:
    ...
    checks = [
        ...
        ("4", "No issue-183 fixture prose contains tenant-brand strings",
