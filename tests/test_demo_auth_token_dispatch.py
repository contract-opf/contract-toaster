#!/usr/bin/env python3
"""
Unit tests for the Docker Compose demo session-token path and get_current_user dispatch
(backend/src/demo_auth.py + backend/src/auth.py).

The Docker Compose deployment has no Cognito: a password login mints a demo HS256 token
