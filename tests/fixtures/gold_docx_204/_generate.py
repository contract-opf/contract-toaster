...
def main() -> None:
    # Explicit "synthetic-generic" (not playbook_registry.DEFAULT_PLAYBOOK_ID -- issue
    # #343 repointed the registry default to the public "sample-agreement"
    # sample playbook, which has no sec-10 sub-clause splits at all): this
    # fixture's planted anchor (sec-10-non-exclusive) only exists in the
    ...
    docx_path = FIXTURE_DIR / "reject-no-exclusivity-doc-level.SYNTHETIC.docx"
