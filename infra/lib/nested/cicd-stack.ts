...
export interface CicdStackProps extends cdk.NestedStackProps {
   ...
   * webhook trigger (issue #233). No default — the caller (top-level stack)
   * resolves this from required CDK context and fails closed if absent.
   */
   ...
   *   "https://github.com/<owner>/<repo>/.github/workflows/ci-pipeline.yml@refs/heads/main"
   */
...
export class CicdStack extends cdk.NestedStack {
  ...
  constructor(scope: Construct, id: string, props: CicdStackProps) {
    ...
    this.buildProject = new codebuild.Project(this, 'BuildProject', {
      ...
      // the configured owner/repo reproduces the current dev behavior.
