...
export class DataStack extends cdk.NestedStack {
  ...
  constructor(scope: Construct, id: string, props: DataStackProps) {
    ...
    //
    // Stores executed tenant agreements (reference corpus) and derived artifacts.
    ...
    //   - email: user's @{hostedDomain} email (see AuthStack.hostedDomain,
    //     issue #349 — for display; not the PK)
    //
