...
// backend/src/reviews.py reserves against)
...
`.trim(),
    ...
    // REAL redline generator (scripts/redline_generate.py) lands with
    ...
    // The one-shot generator that produced it was deleted with the retired
    // standalone writer (issue #631); the committed fixture is unchanged.
    // prune:false so this deployment only PUTs its
